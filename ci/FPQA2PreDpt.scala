...
object FPQA2PreDpt {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val train = ss.sparkContext.textFile("data/nor_trade_train_dptno_b.txt")

    val test = ss.sparkContext.textFile("data/nor_trade_test_dptno_b.txt")
  ...
  def predict(arrays: Array[String], trainLines: Array[String], testLines: Array[String], singleSortedFreqs: Array[String]): Unit = {
    ...
    // output table
    val writer = new BufferedWriter(new FileWriter("data/nor_pre_rate_dpt.csv"))
