...
object PrePSQB2Plu {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = ss.sparkContext.textFile("data/seq_trade_pluno_b.txt")

    val train = ss.sparkContext.textFile("data/seq_trade_train_pluno_b.txt")

    val test = ss.sparkContext.textFile("data/seq_trade_test_pluno_b.txt")
  ...
  def predict(arrays: Array[String], trainLines: Array[String],
    ...
    // output table
    val writer = new BufferedWriter(new FileWriter("data/seq_pre_rate_plu.csv"))
