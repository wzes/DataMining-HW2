...
object PrePSQB2Dpt {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = ss.sparkContext.textFile("data/seq_trade_dptno_b.txt")

    val train = ss.sparkContext.textFile("data/seq_trade_train_dptno_b.txt")

    val test = ss.sparkContext.textFile("data/seq_trade_test_dptno_b.txt")
  ...
  def predict(arrays: Array[String], trainLines: Array[String],
    ...
    // output table
    val writer = new BufferedWriter(new FileWriter("data/seq_pre_rate_dpt.csv"))
