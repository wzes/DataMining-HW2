...
object PrePSQB2Bnd {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val train = ss.sparkContext.textFile("data/seq_trade_train_bndno_b.txt")

    val test = ss.sparkContext.textFile("data/seq_trade_test_bndno_b.txt")
  ...
  def predict(arrays: Array[String], trainLines: Array[String],
    ...
    // output table
    val writer = new BufferedWriter(new FileWriter("data/seq_pre_rate_bnd.csv"))
